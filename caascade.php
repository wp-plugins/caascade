...
function prefix_ajax_caascade_compute() {
  ...
  $fields['expr_1'] = urlencode($_REQUEST['expr_1']);
  $fields['expr_2'] = urlencode($_REQUEST['expr_2']);
  $fields['x_wrt'] = urlencode($_REQUEST['x_wrt']);
  $fields['y_wrt'] = urlencode($_REQUEST['y_wrt']);
  $fields['z_wrt'] = urlencode($_REQUEST['z_wrt']);
  $fields['x_from'] = urlencode($_REQUEST['x_from']);
  $fields['y_from'] = urlencode($_REQUEST['y_from']);
  $fields['z_from'] = urlencode($_REQUEST['z_from']);
  $fields['x_to'] = urlencode($_REQUEST['x_to']);
  $fields['y_to'] = urlencode($_REQUEST['y_to']);
  $fields['z_to'] = urlencode($_REQUEST['z_to']);
  $fields['azimuth'] = urlencode($_REQUEST['azimith']);
  $fields['elevation'] = urlencode($_REQUEST['elevation']);
  $fields['ntics'] = urlencode($_REQUEST['ntics']);
  $fields['grid'] = urlencode($_REQUEST['grid']);
  $fields['logx'] = urlencode($_REQUEST['logx']);
  $fields['logy'] = urlencode($_REQUEST['logy']);
  $fields['contours'] = urlencode($_REQUEST['contours']);
  $fields['box'] = urlencode($_REQUEST['box']);
  $fields['axes'] = urlencode($_REQUEST['axes']);
  $fields['legend'] = urlencode($_REQUEST['legend']);
  $fields['xlabel'] = urlencode($_REQUEST['xlabel']);
  $fields['ylabel'] = urlencode($_REQUEST['ylabel']);
  $fields['zlabel'] = urlencode($_REQUEST['zlabel']);
  $fields['width'] = urlencode($_REQUEST['width']);
  $fields['height'] = urlencode($_REQUEST['height']);
  $fields['format'] = urlencode($_REQUEST['format']);
  $fields_string = '';
